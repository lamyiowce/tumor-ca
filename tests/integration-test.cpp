...
int main() {
    ...
    ca1.runNSteps(4800);
//
//    auto ca1 = Automaton::loadFromFile("../tests/resources/matlab_results/1/out-vnw-tr1-st1-9-FinishCheck.json", &sre);
//    ca1.diffusion();
//    for (unsigned i = 0; i < ca1.params.irradiationSteps.times.size(); i++) {
//        std::cout << ca1.params.irradiationSteps.times[i]
//            << " " << ca1.params.irradiationSteps.doses[i] << std::endl;
//    }
//    auto ca3 = Automaton::loadFromFile(
//            "../tests/resources/matlab_results/2/out-vnw-tr1-st2-1-Diffusion.json",
//            nullptr);
...
//            "../tests/resources/matlab_results/2/out-vnw-tr1-st2-2-IrradiateTumor.json",
//            nullptr);
...
//            "../tests/resources/matlab_results/2/out-vnw-tr1-st2-3-SetLocalStates.json",
//            nullptr);
...
//            "../tests/resources/matlab_results/2/out-vnw-tr1-st2-4-MetaboliseNutrients.json",
//            nullptr);
...
//            "../tests/resources/matlab_results/2/out-vnw-tr1-st2-5-SetGlobalStates.json",
//            nullptr);
...
//            "../tests/resources/matlab_results/2/out-vnw-tr1-st2-6-RepairCells.json",
//            nullptr);
...
//            "../tests/resources/matlab_results/2/out-vnw-tr1-st2-7-CellDivision.json",
//            nullptr);
...
//    return 0;
    ...
    std::cout << maxError(ca1.getState(), ca2.getState()) << std::endl;
